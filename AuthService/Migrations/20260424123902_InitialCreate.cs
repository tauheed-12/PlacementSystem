        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OutboxMessage_ProcessedAt", "\"IsProcessed\" = false OR \"ProcessedAt\" IS NOT NULL");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RefreshToken_ExpiresAt", "\"ExpiresAt\" > \"CreatedAt\"");
                    table.CheckConstraint("CK_RefreshToken_RevokedAt", "\"IsRevoked\" = false OR \"RevokedAt\" IS NOT NULL");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UserToken_ExpiresAt", "\"ExpiresAt\" > NOW()");
                    table.ForeignKey(
