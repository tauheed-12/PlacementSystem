    ...
    public class StudentDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                ...
                entity.Property(s => s.RollNo)
                    .IsRequired()
                    .HasMaxLength(20);

                entity.HasIndex(s => s.RollNo)
                    .IsUnique();
                ...
                entity.HasIndex(s => s.EnrollmentNo)
                    .IsUnique();
            ...
            modelBuilder.Entity<StudentSkill>(entity =>
            {
                ...
                entity.Property(ss => ss.SkillName)
                    .IsRequired()
                    .HasMaxLength(100);
            ...
            modelBuilder.Entity<StudentDocument>(entity =>
            {
                ...
                entity.Property(sd => sd.DocumentUrl)
                    .IsRequired()
                    .HasMaxLength(2048);
